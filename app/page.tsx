  ...
  return (
    <main className="space-y-24 pb-24">
      <section className="relative overflow-hidden">
        ...
        <Container className="grid items-center gap-12 py-16 lg:grid-cols-[1.1fr,0.9fr]">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-sm overflow-hidden rounded-[32px] border border-navy/10 bg-gradient-to-br from-cream via-white to-gold/20 p-8 shadow-soft">
      ...
      <section>
        <Container className="rounded-[36px] border border-navy/10 bg-navy px-6 py-12 text-cream shadow-soft sm:px-10">
          <div className="grid gap-6 lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
            ...
            <div className="flex flex-wrap gap-3 lg:justify-end">
              <Button href="/contacto" className="bg-cream text-navy hover:-translate-y-0.5">
                Agendar consulta
              </Button>
              <Button href="https://wa.me/50687116249" variant="secondary" className="border-cream/40 text-cream hover:text-gold">
                WhatsApp
              </Button>
            </div>
          </div>
