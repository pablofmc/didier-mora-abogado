...
export const metadata: Metadata = {
  title: "Sobre Didier Mora Calvo",
  description:
    "Perfil profesional de Didier Mora Calvo, abogado en Costa Rica con trayectoria y asesoría confiable.",
  alternates: {
    canonical: "/sobre-didier-mora"
  },
  openGraph: {
    title: "Sobre Didier Mora Calvo",
    description:
      "Perfil profesional de Didier Mora Calvo, abogado en Costa Rica con trayectoria y asesoría confiable.",
    url: "/sobre-didier-mora",
    type: "website",
    locale: "es_CR"
  }
};
